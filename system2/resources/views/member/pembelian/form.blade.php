        ...
        <div class="col-md-6">
            <div class="box box-default">
                <div class="box-header">
                    <h3 class="box-title"><a href="{{url('/member')}}" class="btn-loading hidden-lg"></a>Pembelian {{$kategori->product_name}}</h3>
                </div>
                ...
                {{csrf_field()}}
                    <div class="box-body">
                        ...
                        @endif
                            ...
                            <!-- ===================================== Pulsa All Operator ===================================== -->
                            @if(in_array(strtoupper($kategori->type), ["REGULER","TRANSFER","PULSA","PAKETSMS"]))
                            ...
                            @elseif(in_array(strtoupper($kategori->type), ["LAIN","SMS","INTERNET","DATA","VOUCHER","E-MONEY","PAKET SMS & TELPON","PAKETTLFON"]))
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row hidden-lg hidden-md">
         ...
         <div class="box">
            <div class="box-header">
               <h3 class="box-title"><a href="{{url('/member')}}" class="hidden-lg btn-loading"></i></a>Riwayat Transaksi</h3>
            </div><!-- /.box-header -->
            <div class="box-body" style="padding: 0px">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <form action="{{ url('/member/process/orderproduct') }}" method="POST" id="order_form">
                ...
                <input type="hidden" name="pin" id="pin_submit" value="">
