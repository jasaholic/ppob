         ...
         <div class="col-md-6">
            <div class="box box-default">
               <div class="box-header with-border">
                  <h3 class="box-title"><a href="{{url('/member/deposit')}}" class="btn-loading hidden-lg"></i></a>Detail Deposit</h3>
               ...
               <div class="box-body" style="color: #6E6C6C">
                  <table>
                     <tr>
                        <td width="50px">
                           <img src="{{asset('img/logo/'.$logo->img)}}" style="display: inline;width: 100px; margin-right:10px;">
                        </td>
                        <td>
