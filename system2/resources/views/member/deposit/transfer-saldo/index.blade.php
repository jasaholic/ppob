                ...
                {{csrf_field()}}
                    <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('nominal') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">{{ucwords($setting->unit_point_name)}}</div>
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td style="border-style: none;" align="right">
                                    ...
                                    <div style="font-size:12px;color:grey;">Sisa saldo anda adalah {{number_format(Auth::user()->saldo, 2, '.', '').' '.$setting->unit_point_name}} </div>
                                </td>
                            </tr>
                        </table>
                    </div>
