        ...
        <div class="col-md-6">
            <div class="box box-default">
                <div class="box-header">
                    <h3 class="box-title"><a href="{{url('/member')}}" class="btn-loading hidden-lg"></a>Membership</h3>
                </div>
                ...
                <div class="media">
                      @if(Auth::user()->roles()->first()->id == '1' || Auth::user()->roles()->first()->id == '2')
                        <div class="pull-left">
                            <img class="media-object" src="{{asset('/img/personal.png')}}" height="100px">
                        </div>
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    <ol>
                        ...
                        <li>Ada fasilitas tambahan berupa API, Transfer Saldo & Support khusus.</li>
                    </ol>
                </div>
            </div>
        </div>
