   ...
   <section class="content">
      <div class="row">
         <div class="col-md-6">
            <div class="box box-default">
               <div class="box-header">
                 <h3 class="box-title"><a href="{{url('/member')}}" class="btn-loading hidden-lg"></i></a>Transfer Bank</h3>
               </div>
               ...
               {{csrf_field()}}
                  <div class="box-body">
                    ...
                    <div class="form-group{{ $errors->has('nominal') ? ' has-error' : '' }}">
                        ...
                        <i>Biaya admin Rp. 5.000/transaksi langsung terpotong dari saldo.</i></p>
                     </div>
        ...
        <div class="col-md-6">
            <div class="box box-default">
                <div class="box-header">
                    <h3 class="box-title"><a href="{{url('/member')}}" class="btn-loading hidden-lg"></i></a>Syarat & Ketentuan</h3>
                </div>
                <div class="box-body" align="left">
                    ...
                    <p>
                    <p><b>Ketentuan :</b>
                    <br/>1. Biaya Admin Rp. 5.000/transaksi 
