        ...
        <div class="col-md-6">
            <div class="box box-default">
                <div class="box-header">
                    <h3 class="box-title"><a href="{{url('/member')}}" class="btn-loading hidden-lg"></i></a>Referral</h3>
                </div>
                <div class="box-body" align="center">
                    ...
                    <p>Selain itu apabila akun sobat berlevel Enterprise dan memiliki user referral yang berlevel agen maka sobat bisa mendapat komisi sesuai harga produk yang telah ditetapkan oleh admin per transaksinya.</p>
...
Terima kasih banyak.</p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control input-lg" id="ref" type="text" value="{{url('/')}}/register?ref={{Auth::user()->id}}" readonly style="text-align:center;">
