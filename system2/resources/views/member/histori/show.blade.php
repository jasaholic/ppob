...
@media and screen(max-with:576px){
    .btn-print-desktop{
        display:none;
    }
    .btn-print-mobile{
         ...
         <div class="col-md-6">
            <div class="box box-default">
               <div class="box-header with-border">
                  <h3 class="box-title"><a href="{{url('/member/riwayat-transaksi')}}" class="btn-loading hidden-lg"></a>Detail Transaksi</h3>
                  <div class="box-tools pull-right">
                     <a href="{{url('/print/'.$hash.'.pdf?view=desktop')}}" class="btn-print-desktop" target="_blank"><i class="fa fa-print fa-lg" style="margin-top: 8px;margin-right: 5px;"></i> CETAK STRUK</a>
                     <a href="{{url('/print/'.$hash.'.pdf?view=mobile')}}" class="btn-print-mobile" target="_blank"><i class="fa fa-print fa-lg" style="margin-top: 8px;margin-right: 5px;"></i> CETAK STRUK</a>
                  </div>
               </div>
