    ...
    <div class="row">
        ...
        <div class="box box-solid">
            <div class="box-header with-border header-profile" style="display:none;">
                <h3 class="box-title"><a href="{{url('/member')}}" class="btn-loading hidden-lg"></i></a><b>DATA PROFIL</b></h3>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="list-group">
                            ...
                            <a href="{{url('/member/api-credentials')}}" class="btn-loading list-group-item {{ url('/member/api-credentials')  == request()->url() ? 'active' : '' }}"><i class="fa fa-fire" style="margin-right: 5px;"></i> API</a>
                        </div>
                    </div>
                </div>
            </div><!-- /.box-body -->
