...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="{{url('/member/validation-users')}}" class="btn-loading">Validation Users</a></li>
   </ol>
   </section>
         ...
         <div class="col-md-6">
            <div class="box box-green">
               <div class="box-header">
                 <h3 class="box-title"><a href="{{url('/admin')}}" class="hidden-lg btn-loading"></a>Validasi</h3>
               </div>
               @if(!$validation)
