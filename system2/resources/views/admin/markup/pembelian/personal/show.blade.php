                            ...
                            <div class="box-body table-responsive no-padding">
                               ...
                               <thead>
                                  ...
                                  <tr style="font-size: 13px;">
                                     ...
                                     @endif
                                     <td>
                                        <a href="{{url('/admin/pembelian-produk/markup/role-personal/'.$kategori->slug.'/edit', $produk->id)}}" class="btn-loading btn btn-primary btn-sm" style="padding: 2px 5px;font-size: 10px;"><i class="fa fa-pencil-square-o fa-fw"></i>Ubah</a>
