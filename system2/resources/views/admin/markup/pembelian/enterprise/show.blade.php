                            ...
                            <div class="box-body table-responsive no-padding">
                               ...
                               <thead>
                                  ...
                                  <tr style="font-size: 13px;">
                                     ...
                                     @endif
                                     <td>
                                        <a href="{{url('/admin/pembelian-produk/markup/role-enterprise/'.$kategori->slug.'/edit', $produk->id)}}" class="btn-loading btn btn-primary btn-sm" style="padding: 2px 5px;font-size: 10px;"><i class="fa fa-pencil-square-o fa-fw"></i>Ubah</a>
                                        <form method="POST" action="{{ route('admin.produkEnterprise.delete', $produk->id) }}" accept-charset="UTF-8">
                                            <input name="_method" type="hidden" value="DELETE">
                                            <input name="_token" type="hidden" value="{{ csrf_token() }}">
                                            <button class="btn btn-danger btn-sm btn-loading" onclick="return confirm('Anda yakin akan menghapus data ?');" type="submit" style="padding: 2px 5px;font-size: 10px;margin:4px 0px 4px 0px"><i class="fa fa-trash"></i> Hapus</button>
                                         </form>
                                     </td>
                                  </tr>
                                  @endforeach
