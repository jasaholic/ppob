  ...
  <div class="row">
      <div class="col-md-12">
          <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD;text-align:center;">
              <div class="pull-left" style="padding-left:10px;padding-right:10px;padding-bottom:5px;padding-top:10px;margin-top:0px;font-style:italic;">Status Server (HijauPay)</div>
