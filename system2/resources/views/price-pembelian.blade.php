            ...
            <table class="table table-striped table-bordered" style="font-size: 15px;margin-bottom: 50px;">
                ...
                <tbody align="left">
                    ...
                    <tr>
                        ...
                        <td class="text-right"> {{number_format($produk->V_pembelianproduk_personal->price, 2, '.', '')}} GISCO</td>
                        <td class="text-right">{{number_format($produk->V_pembelianproduk_agen->price, 2, '.', '')}} GISCO</td>
                        <td class="text-right">{{number_format($produk->V_pembelianproduk_enterprise->price, 2, '.', '')}} GISCO</td>
                        @if($produk->status == 1)
