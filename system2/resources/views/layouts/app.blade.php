...
<html lang="id">
   ...
   <!-- Favicon -->
   <link rel="shortcut icon" type="image/icon" href="{{asset('/assets/images/favicon.png')}}"/>
         ...
         <div class="container">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="{{url('/')}}">
                  <img class="logo-scroll img-responsive" src="{{ asset('images/logo-dark.png') }}" alt="logo" style="max-width: 150px;">
                  <img class="logo-dark-scroll img-responsive" src="{{ asset('images/logo-dark.png') }}" style="display: none;max-width: 150px;">
               </a>
            </div>
            ...
            <div id="navbar" class="navbar-collapse collapse">
               <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                  ...
                  <li><a href="{{url('/api-docs')}}">API Pulsa H2H</a></li>
                  @if(Auth::check())
