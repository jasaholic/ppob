...
Route::get('/deposit/{id}', 'DepositController@showDeposit');
Route::post('/deposit/konfirmasi', 'DepositController@konfirmasiPembayaran');
...
Route::get('/riwayat_deposit','DepositController@riwayat_deposit');
Route::get('/va_number/{id}','DepositController@showNomerVa');
Route::get('/bank-cek/{id}','DepositController@bank_cek');
//======================================================== End Deposit ===========================================================

//=================================================== Route Transfer Saldo =======================================================
Route::get('/transfer-saldo', 'DepositController@transferSaldo');
Route::post('/transfer-saldo/cek-nomor', 'DepositController@cekNomor');
Route::post('/transfer-saldo/kirim', 'DepositController@kirimSaldo');
//================================================== End Route Tranfer Saldo =====================================================

//==================================================== Route Mutasi Saldo ========================================================
Route::get('/mutasi-saldo', 'DepositController@mutasiSaldo');
Route::post('/mutasi-saldo-datatables', 'DepositController@mutasiSaldoDatatables')->name('get.mutasiSaldo.datatables');
...
Route::post('/process/cektagihan', 'PembayaranController@cektagihan');
Route::post('/process/cektagihan/home', 'PembayaranController@cektagihanhome');
Route::post('/process/bayartagihan', 'PembayaranController@bayartagihan')->name('bayartagihan');
...
Route::post('/process/orderproduct', 'PembelianController@orderproduct');
Route::post('/process/orderproduct/home', 'PembelianController@orderproducthome');
...
//===================================================== Route Voucher ============================================================
Route::get('/redeem-voucher', 'DepositController@redeemVoucher');
