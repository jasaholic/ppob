...
class MembershipController extends Controller
{
  ...
  public function index()
  {
      ...
      return view('member.membership.index', compact('selisihhari','endedTimestamp','timestampMinus','awal','minusDay','toDay','countTransaksiSuccesBulan','countTransaksiGagalBulan','countTransaksiProsesBulan'));
  }
