...
use DB, Exception, Log, DigiFlazz,Auth,Validator,Input;
use App\User;
    ...
    public function handle()
    {
        ...
        //     }
            ...
            if( $duplicateAntrian <= 0 )
            {
                ...
                if( $produk->pembelianoperator->product_id == 'TOKEN' )
                {
                ...
                if($this->apiserver_id  == 1)
                {
                    ...
                    if($produk->pembelianoperator->product_id == 'TOKEN')
                    {
                        ...
                        $order = DigiFlazz::order($trxid,$this->code,$this->sequence,null,$this->no_meter_pln);
                    }
                    else
                    {
                        ...
                        $order = DigiFlazz::order($trxid,$this->code,$this->sequence,$this->target);
                    }
                    ...
                    if($result->success == false && $result->connected == false)
                    {
                        ...
                        {
                            throw new Exception('Tidak dapat diproses',0);
                        }
                        else
                        {
                ...
                {
                    throw new Exception("Unknown resource",0);
                }
            }
